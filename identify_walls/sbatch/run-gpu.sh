...
nvcc identifyWalls.cpp fileHandler.cpp dataFrame.cpp gpuImplementation.cu segmentMerging.cu bendDetection.cu -Xcompiler -Wall -Xptxas -O3 -Xcompiler -O3 --use_fast_math -std=c++17 -o identifyWalls
