...
# Configuration
COLLECTION_TIME=10      # Collect data for 10 seconds
...
python3 LiDARCollector.py --launch-file=$LIDAR_LAUNCH_FILE --lidar-ip=192.168.1.1 --receiver-ip=$LIDAR_RECEIVING_IP --collection-time=$COLLECTION_TIME